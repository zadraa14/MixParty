  ...
  return (
    <header className="flex items-center justify-between">
      <div className="group flex items-center gap-3 sm:gap-4">
        ...
        <div
          aria-label="MixParty"
          className="hidden -skew-x-6 font-[family:var(--font-exo-2)] text-[2rem] font-black leading-none tracking-[0.16em] transition-transform duration-300 group-hover:scale-[1.03] min-[420px]:block sm:text-[2.5rem]"
        >
