    ...
    <main className="relative isolate min-h-screen overflow-hidden bg-[#070711] font-[family:var(--font-geist-sans)] text-white">
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 pb-16 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="fixed bottom-5 right-5 z-50">
          <a
            href={`/share/${encodeURIComponent(result.code)}`}
            className="inline-flex rounded-2xl bg-gradient-to-r from-violet-500 via-fuchsia-500 to-orange-400 px-5 py-3 text-sm font-black text-white shadow-2xl"
          >
            Partager
          </a>
        </div>
